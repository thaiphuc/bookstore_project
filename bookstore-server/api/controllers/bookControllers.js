...
const updateBookItem = async (req, res) => {
  const bookId = req.params.id;
  console.log(bookId);
  const { _id, name, description, image, category, author, publisher, price, quantity, publishYear ,createdAt } =
    req.body;
  // console.log(req.body)
  try {
    const updatedBook = await Book.findByIdAndUpdate(
      bookId,
      { name, description, image, category, author, publisher, price, quantity, publishYear },
